sap.ui.define([
    ...
    function (Controller, MessageBox, JSONModel, Formatter) {
        ...
        return Controller.extend("demo.project1061023338.controller.TestView1", {
            formatter: Formatter,
            onInit: function () {

                this.getView().byId("idSimpleForm1").bindElement("employees>/people/0/");
                ...
                */
                ...
                /*
                var fProductWidth = oProductsModel.getProperty("/products/0/DimensionWidth");
                var fProductDepth = oProductsModel.getProperty("/products/0/DimensionDepth");
                var fProductHeight = oProductsModel.getProperty("/products/0/DimensionHeight");
                
                var fProductVolume = fProductWidth * fProductDepth * fProductHeight;
                
                oProductsModel.setProperty("/products/0/Volume", fProductVolume);
                */


                var aProductsData = oProductsModel.getData("products");
                var ProductsArray = Object.values(aProductsData.products);

                ProductsArray.forEach((product) => {
                    var fProductWidth = product.DimensionWidth;
                    var fProductDepth = product.DimensionDepth;
                    var fProductHeight = product.DimensionHeight;
                    
                    var fProductVolume = fProductWidth * fProductDepth * fProductHeight;
                
                    product.Volume = fProductVolume;

                });

                /*aProductsData = Object.assign({}, ProductsArray);*/
                aProductsData.products = ProductsArray;
                oProductsModel.setData(aProductsData);
                //this.getView().setModel(oProductsModel, "products");
            ...
            onChangeName: function (oEvent) {
                ...
                var fPrice = 10.55;
                var dBirthday = "1995-10-24";
                var aMyArray = [1,3,4,5];
                var oMyObject = {
                    "FirstName": "G",
                    "LastName" : "M"
                };
            ...
            onItemNavigation: function(oEvent){
                var sProductsPath = oEvent.getSource().getBindingContext("products").getPath();
                var sProductId = sProductsPath.split("/")[2];

                var oRouter = this.getOwnerComponent().getRouter();
                oRouter.navTo("productDetails", {"id": sProductId});
            },

            onChangeMeasurement: function(oEvent){
                var oBindingContext = oEvent.getSource().getBindingContext("products");
                // var sPath = oBindingContext.getPath();

                var oProduct = oBindingContext.getObject();
                oProduct["Volume"] = this._calculateVolume(oProduct.DimensionWidth, oProduct.DimensionDepth, oProduct.DimensionHeight)
                ...
                // this.getView().getModel("products").setProperty(sPath + "/Volume", this._calculateVolume(fWidth, fDepth, fHeight));
            },

            _calculateVolume: function(fWidth, fDepth, fHeight ) {
