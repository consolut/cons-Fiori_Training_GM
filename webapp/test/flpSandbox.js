		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demoproject1061023338-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoproject1061023338-display": {
								"semanticObject": "demoproject1061023338",
								"action": "display",
								"description": "My test SAPUI5 application",
								"title": "Demo application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.project1061023338",
									"url": sap.ui.require.toUrl("demo/project1061023338")
								}
							}
						}
					}
